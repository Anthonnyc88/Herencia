 ...
 * @author Anthonny
 */
public class interfazFurgoneta extends javax.swing.JFrame {

    /**
     * Creates new form interfazFurgoneta
     */
    public interfazFurgoneta() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Furgoneta");

        jLabel2.setText("Capasidad");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(interfazFurgoneta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new interfazFurgoneta().setVisible(true);
            }
        });
    }
